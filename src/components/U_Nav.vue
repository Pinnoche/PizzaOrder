      ...
      <div class="max-w-full mx-auto flex items-center justify-between">
        ...
        <div class="hidden w-full ml-60 md:flex md:justify-between">
            <div>
                ...
                <RouterLink to="/your_order" class="text-white text-lg hover:bg-gray-700 px-3 py-2 rounded-md">Orders</RouterLink>
                <RouterLink to="/about" class="text-white text-lg hover:bg-gray-700 px-3 py-2 rounded-md">About</RouterLink>
            </div>
          <div class="md:flex md:justify-end">
            <section v-if="!authStore.user" class="cursor-pointer">
              <RouterLink to="/login" class="text-white hover:bg-gray-700 px-3 py-2 rounded-md">Login</RouterLink>
        ...
        <div v-if="isMenuOpen" class="md:hidden absolute top-20 right-1 font-semibold z-10">
          <div class="bg-white rounded-lg shadow-lg pt-2 pb-3 space-y-1 ">
            ...
            <RouterLink to="/your_order" class="hover:bg-gray-700 block px-3 py-2 rounded-md">Orders</RouterLink>
            <section v-if="!authStore.user" class="cursor-pointer">
              <RouterLink to="/login" class=" hover:bg-gray-700 block px-3 py-2 rounded-md">Login</RouterLink>
