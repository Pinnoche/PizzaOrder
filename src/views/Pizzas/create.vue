    ...
    <div>
        ...
        <form class="grid grid-cols-1 gap-6 max-w-lg mx-auto" @submit.prevent="savePizza">
            ...
            <div class="bg-gray-100 rounded-lg p-6">
                ...
                <input v-model="data.pizza.name" type="text" class="w-full px-4 py-2 rounded-md bg-gray-200 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500" id="fullName" >
            ...
            <div class="bg-gray-100 rounded-lg p-6">
                ...
                <select v-model="data.pizza.type" name="type" class="w-full px-4 py-2 rounded-md bg-gray-200 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500" id="pizzaType" >
            ...
            <div class="bg-gray-100 rounded-lg p-6">
                ...
                <select v-model="data.pizza.base" name="base" class="w-full px-4 py-2 rounded-md bg-gray-200 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500" id="pizzaBase" >
